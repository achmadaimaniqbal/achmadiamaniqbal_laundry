								...
								<div class="x_content">
                                    ...
                                    ?>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input id="alamat" class="form-control" type="text" name="alamat" required="required"  value="<?= $o->alamat ?>">
											</div>
										</div>
                                        <div class="item form-group">
											<label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Telepon <span class="required"></span></label>
											<div class="col-md-6 col-sm-6 ">
												<input id="telepon" class="form-control" type="text" name="telepon" required="required"  value="<?= $o->tlp ?>">
											</div>
										</div>
